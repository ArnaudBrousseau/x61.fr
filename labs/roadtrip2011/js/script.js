/* Author: Arnaud Brousseau */
  ...
  if (screen.width > 480) {
    //We assume we're on a wide enough screen to switch to "map" display
    displayMap();
  } else {
    //If the screen is tiny, let's give the user the possibility to switch display anyway
    document.getElementById("switchToMapBox").style.display = "block";
